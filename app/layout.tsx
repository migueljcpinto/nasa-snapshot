...
export const metadata: Metadata = {
  title: "Nasa Snapshot",
  description: "APOD Nasa Snapshot",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} bg-gray-50 text-gray-950 relative pt-5 sm:pt-15 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}
      >
